    ...
    <main className="max-w-3xl mx-auto px-6 md:px-12 py-10">
      ...
      {conversations.length === 0 ? (
        <div className="text-center py-20 bg-white border border-gray-100 rounded-xl">
          <span className="material-symbols-outlined text-gray-300 text-5xl mb-4 block">forum</span>
          ...
          {conversations.map((conv) => {
            ...
            return (
              <Link key={conv.id} to={`/messages/${conv.id}`}
                ...
                <div className="w-11 h-11 bg-emerald-100 text-emerald-700 rounded-full flex items-center justify-center text-sm font-bold shrink-0">
